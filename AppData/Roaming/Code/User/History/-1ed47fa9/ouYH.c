...
void display(void)
{
    if (startFlag == TRUE)
    {
        if (firstFlag == FALSE && secondFlag == FALSE && thirdFlag == FALSE)
        {
            GPIOB->ODR = 0b00000001;
        }
        else if (firstFlag == TRUE && secondFlag == FALSE && thirdFlag == FALSE)
        {
            firstDisplay();
        }
        else if (firstFlag == FALSE && secondFlag == TRUE && thirdFlag == FALSE)
        {
            secondDisplay();
        }
        else if (firstFlag == FALSE && secondFlag == FALSE && thirdFlag == TRUE)
        {
            thirdDisplay();
        }
    }

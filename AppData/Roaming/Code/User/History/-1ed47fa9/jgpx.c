...
void display(void)
{
    ...
    if else((startFlag == TRUE) & (firstFlag == TRUE) & (secondFlag == FALSE) & (thirdFlag == FALSE))
    {   
        firstDisplay();
    }    
    if else((startFlag == TRUE) & (firstFlag == FALSE) & (secondFlag == TRUE) & (thirdFlag == FALSE))
    {   
        secondDisplay();
    }    
    if else((startFlag == TRUE) & (firstFlag == FALSE) & (secondFlag == FALSE) & (thirdFlag == TRUE))
    {  
        thirdDisplay();
    }     
}
